...
//           <div style={{ height: '40px', width: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
//             <img src="/logostart.png" alt="CodeFusionAI Logo" className="h-10 w-10 rounded-full shadow-lg transition-transform group-hover:scale-110 animate-spin-slow" style={{ animation: 'spin 6s linear infinite' }} />
//           </div>
//           <span className="text-2xl font-bold text-white tracking-wide">CodeFusion AI</span>
//         </Link>
...
//                 <a href="https://x.com/Sobansaud12345" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
//                   <Twitter className="h-5 w-5" />
//                 </a>
//                 <a href="https://www.linkedin.com/in/muhammad-soban-saud-235a6b2ba" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
...
//                     </Button>
//                   </Link>
//                   <Button variant="ghost" onClick={signOut} className="text-white w-full">
