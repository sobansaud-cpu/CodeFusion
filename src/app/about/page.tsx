      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-purple-400 via-indigo-400 to-cyan-400 bg-clip-text text-transparent mb-6 tracking-tight">
            Discover CodeFusion AI
          </h2>
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed">
            A visionary AI platform transforming ideas into enterprise-grade applications. Founded by an industry-leading developer committed to innovation and excellence.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            <h2 className="text-4xl font-black text-white mb-4">Visionary Founder & Tech Leader</h2>
            ...
            <p className="text-lg text-gray-300 mb-8 leading-relaxed">
              As a seasoned full-stack engineer and AI specialist, I architect robust, scalable solutions that drive real business impact. 
              With a track record of delivering high-performance applications, I founded CodeFusion AI to bridge the gap between complex technology and seamless user experiences—empowering startups, enterprises, and innovators to scale seamlessly.
            </p>
        ...
        <div className="mb-20">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-12 border border-white/10 transition-all duration-300 hover:shadow-purple-500/20">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed mb-6">
              CodeFusion AI emerged from a passion to revolutionize how we build digital experiences. As a solo founder with extensive experience in AI and web technologies, 
              I identified the inefficiencies in traditional development processes. Our mission is to provide enterprise-level tools that accelerate innovation, reduce costs, 
              and enable seamless scalability—helping businesses thrive in the digital age.
            </p>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
              We're committed to delivering value that attracts investors and clients alike, with a proven track record of user growth and technological advancement.
            </p>
          </div>
        </div>
