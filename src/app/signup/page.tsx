...
import { Mail, Loader2, Lock, ArrowRight, CheckCircle, Sparkles } from 'lucide-react';
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden flex items-center justify-center px-4">
      ...
      {/* EXACT SAME GOD-TIER BACKGROUND AS LOGIN & PAYMENT */}
        ...
        <Card className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden hover:border-purple-500/30 hover:shadow-purple-500/20 transition-all duration-500">
          ...
          <CardHeader className="text-center pt-10 pb-8">
            <div className="flex justify-center mb-6">
              <div className="p-4 bg-gradient-to-br bg-white from-purple-500 to-cyan-500 rounded-2xl shadow-xl">
                <img
                  src="/CODEFUSION.png"
                  alt="CodeFusion Logo"
            ...
            <p className="text-gray-400 mt-3 text-base font-light">
              Join thousands building with AI — free forever
            </p>
          </CardHeader>
          ...
          <CardContent className="px-8 pb-10 space-y-6">
            ...
            <form onSubmit={handleEmailSignup} className="space-y-5">
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-gray-300 font-medium text-sm flex items-center gap-2">
                  <Lock className="h-4 w-4 text-purple-400" />
                  Confirm Password
                </Label>
                <Input
